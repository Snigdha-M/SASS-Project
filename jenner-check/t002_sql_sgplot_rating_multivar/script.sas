/* Adapted from "SASS Project.sas" (Chicago Energy Benchmarking analysis).
   ...
   the bundle is self-contained. Analysis logic (block 2: buildings of
   different energy ratings compared by electricity/gas usage and
   ENERGY STAR score) is unmodified from the source script. */
