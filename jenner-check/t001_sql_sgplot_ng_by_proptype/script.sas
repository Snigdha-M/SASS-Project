/* Adapted from "SASS Project.sas" (Chicago Energy Benchmarking analysis).
   ...
   the bundle is self-contained. Analysis logic (block 1: Top Natural Gas
   Consumption by Property Type, Reporting status = Submitted Data) is
   unmodified from the source script. */
